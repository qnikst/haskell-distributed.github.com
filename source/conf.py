# -*- coding: utf-8 -*-
#
# Haskell Distributed documentation build configuration file, created by
...
project = u'Cloud Haskell'
copyright = u'2016, Haskell distributed team'
author = u'Haskell distributed team'
...
html_title = "Cloud Haskell User Guide"
...
htmlhelp_basename = 'HaskellDistributeddoc'
...
latex_documents = [
    (master_doc, 'HaskellDistributed.tex', u'Haskell Distributed Documentation',
     u'Haskell distributed team', 'manual'),
]
...
man_pages = [
    (master_doc, 'haskelldistributed', u'Haskell Distributed Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'HaskellDistributed', u'Haskell Distributed Documentation',
     author, 'HaskellDistributed', 'One line description of project.',
     'Miscellaneous'),
]
